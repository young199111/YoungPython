...
def main():
    ...
    groups = [
        # 联营
        ('483ded9fb274421c4beb896acf1a725e9804334474cc9b0306c1faad33f42403',
         'SEC358b17be862902c1e9ae459d31e6519b0be99ce2d9f236e8d50da61b4ebab711')
    ]
    ...
    # 客端CRM
    all_list = [
        'issuetype = "缺陷(Bug)" AND status in ("[BUG]待修复", "[Bug]待回归", "[Bug]正常关闭", "[Bug]待测试确认") AND text ~ 【SAAS1.0】'
    ]
    fixed_list = [
        'issuetype = "缺陷(Bug)" AND status in ("[Bug]待回归", "[Bug]正常关闭") AND text ~ 【SAAS1.0】'
    ]
    to_fix_list = [
        'issuetype = "缺陷(Bug)" AND status = "[BUG]待修复" AND text ~ 【SAAS1.0】'
    ]
    to_check_list = [
        'issuetype = "缺陷(Bug)" AND status = "[Bug]待测试确认" AND text ~ 【SAAS1.0】'
    ]
